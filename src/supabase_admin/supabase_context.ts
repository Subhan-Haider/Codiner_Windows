...
async function getPublishableKey({
  ...
  if (!publishableKey) {
    throw new Error(
      "No publishable key found for project. Make sure you are connected to the correct Supabase account and project. See https://codiner.sh/docs/integrations/supabase#no-publishable-keys",
    );
  }
