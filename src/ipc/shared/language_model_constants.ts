...
> = {
  ...
  vertex: {
    ...
    // Use the same gateway prefix as Google Gemini for Codiner Pro compatibility.
    gatewayPrefix: "gemini/",
    secondary: true,
  },
  openrouter: {
  ...
  auto: {
    displayName: "Codiner Pro",
    websiteUrl: "https://www.codiner.online/pro",
    gatewayPrefix: "codiner/",
  },
  azure: {
