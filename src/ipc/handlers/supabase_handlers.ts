...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a Codiner app to a Supabase project
  handle(
  ...
  // Unset app project - removes the link between a Codiner app and a Supabase project
  ...
  testOnlyHandle(
    ...
    async (
      ...
      safeSend(event.sender, "deep-link-received", {
        ...
        url: "https://supabase-oauth.codiner.sh/api/connect-supabase/login",
      });
      logger.info(
