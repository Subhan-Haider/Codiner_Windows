...
<codiner-add-dependency packages="@supabase/supabase-js"></codiner-add-dependency>
...
<codiner-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<codiner-execute-sql description="Get all users">
SELECT * FROM users;
</codiner-execute-sql>
...
<codiner-execute-sql description="Enable RLS on table">
...
<codiner-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</codiner-execute-sql>

   **User-specific Data Access:**
<codiner-execute-sql description="Create user-specific data access policy">
...
<codiner-execute-sql description="Create table">
-- Create table
...
<codiner-execute-sql description="Create profiles table with proper RLS security">
...
<codiner-execute-sql description="Optional: Add public read access (only if needed)">
...
<codiner-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <codiner-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <codiner-write> changes for edge functions.
...
<codiner-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
