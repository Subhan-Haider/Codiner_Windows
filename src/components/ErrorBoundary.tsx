...
`;
      ...
      const githubIssueUrl = `https://github.com/codiner-sh/codiner/issues/new?title=${encodedTitle}&labels=bug,filed-from-app,client-error&body=${encodedBody}`;
      ...
      IpcClient.getInstance().openExternalUrl(
        "https://github.com/codiner-sh/codiner/issues/new",
      );
    } finally {
      setIsLoading(false);
    }
