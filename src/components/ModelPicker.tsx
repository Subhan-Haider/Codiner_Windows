import { isCodinerProEnabled, type LargeLanguageModel } from "@/lib/schemas";
...
export function ModelPicker() {
  ...
  if (settings && isCodinerProEnabled(settings)) {
          ...
          <>
            ...
            {primaryProviders.map(([providerId, models]) => {
              models = models.filter((model) => {
                // Don't show free models if Codiner Pro is enabled because
                // we will use the paid models (in Codiner Pro backend) which
