...
interface CodinerMcpToolResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const CodinerMcpToolResult: React.FC<CodinerMcpToolResultProps> = ({
  node,
  children,
}) => {
  ...
  const prettyJson = useMemo(() => {
    ...
    try {
      ...
      console.error("Error parsing JSON for Codiner-mcp-tool-result", e);
      return raw;
    }
  }, [expanded, raw]);
