...
interface CodinerMcpToolCallProps {
  node?: any;
  children?: React.ReactNode;
}

export const CodinerMcpToolCall: React.FC<CodinerMcpToolCallProps> = ({
  node,
  children,
}) => {
  ...
  const prettyJson = useMemo(() => {
    ...
    try {
      ...
      console.error("Error parsing JSON for Codiner-mcp-tool-call", e);
      return raw;
    }
  }, [expanded, raw]);
