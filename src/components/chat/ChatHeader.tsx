      ...
      <div className="@container flex items-center justify-between pb-1.5 pt-0.5">
        <div className="flex items-center gap-2 pl-2">
          <Button
            ...
            variant="secondary"
            className="flex items-center justify-start gap-2 py-1.5 h-9 px-4 rounded-lg shadow-sm border border-border/40 hover:bg-secondary/80 transition-all font-medium"
          >
          ...
          <Button
            ...
            variant="ghost"
            className="flex cursor-pointer items-center gap-2 text-sm px-3 py-1.5 rounded-lg text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all font-medium"
          >
