                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[300px]">
                    {isSmartContextEnabled ? (
                      <p>
                        With Smart Context, Codiner uses the most relevant files as
                        context.
                      </p>
                    ) : (
                      <p>By default, Codiner uses your whole codebase.</p>
                    )}
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            {contextPaths.length > 0 ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center">
                <p className="text-sm text-muted-foreground">
                  {isSmartContextEnabled
                    ? "Codiner will use Smart Context to automatically find the most relevant files to use as context."
                    : "Codiner will use the entire codebase as context."}
                </p>
              </div>
            )}
          </TooltipProvider>
