...
export function getCodinerAppPath(appPath: string): string {
  ...
  if (IS_TEST_BUILD) {
    ...
    return path.join(electron!.app.getPath("userData"), "codiner-apps", appPath);
  }
  return path.join(os.homedir(), "codiner-apps", appPath);
}
