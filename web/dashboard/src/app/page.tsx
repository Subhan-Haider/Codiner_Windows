...
export default function GeneratedApp() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-300 max-w-2xl">
          AI-generated ${selectedType} application with modern design and functionality
        </p>
      </div>
    </div>
  )
  ...
  return (
    <div className="min-h-screen space-y-8 animate-fade-in">
      {/* Hero Section */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 p-8 md:p-12 mb-8">
